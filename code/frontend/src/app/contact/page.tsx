  ...
  return (
    <div className={styles.contactWrap}>
      ...
      <form action="#">
        ...
        <div className={styles.formGroup}>
            <span>이름 <b className={styles.red}>*</b></span>
            <input type="text" />
        </div>
        <div className={styles.formGroup}>
            <span>연락처 <b className={styles.red}>*</b></span>
            <input type="text" />
        </div>
        <div className={styles.formGroup}>
            <span>이메일 <b className={styles.red}>*</b></span>
            <input type="text" />
        </div>
        <div className={styles.formGroup}>
            <span>제목 <b className={styles.red}>*</b></span>
            <input type="text" />
        </div>
        <div className={styles.formGroup}>
            <span>문의내용 <b className={styles.red}>*</b></span>
            <textarea cols={TEXTAREA_COLS} rows={TEXTAREA_ROWS}></textarea>
        </div>
        <div className={styles.formGroup}>
            <span>옵션 <b className={styles.red}>*</b></span>
            <span><input type="checkbox" />익명</span>
            <span><input type="checkbox" />사용자</span>
        </div>
      </form>
      </div>
      <div className={styles.agreeWrap}>
        ...
        <div className={styles.listWrap}>
            <p>1. 개인정보의 수집 및 이용 목적 문의 확인 및 답변을 위한 연락통지, 처리결과 통보 등을 목적으로 개인정보를 처리합니다.</p>
            <p>2. 처리하는 개인정보 항목</p>
            <p>• 필수항목 : 이름, 연락처, 이메일, 제목, 문의내용</p>
            <p>3. 개인정보의 처리 및 보유 기간</p>
            <p>①법령에 따른 개인정보 보유.이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의 받은 개인정보 보유, 이용기간 내에서 개인정보를 처리, 보유 합니다.</p>
